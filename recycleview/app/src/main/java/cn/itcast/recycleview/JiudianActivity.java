...
public class JiudianActivity extends AppCompatActivity {
    ...
    private String[] name1 = {"danrenjian","shuangrenjian","jiatingjian"};
    private int[] image = {R.drawable.danrenjian,R.drawable.shuangrenjian,R.drawable.jiatingjian};
    private  String[] buy ={"¥180","¥200","¥300"};
    private  String[] introduces = {"Single bed with window  18-22 square meter",
            "Two beds with window  24-26 square meter",
            "Three beds with window 34-36 square meter"};
    int imageone;
    String nameone;
    String buyone;
    String troduceone;
