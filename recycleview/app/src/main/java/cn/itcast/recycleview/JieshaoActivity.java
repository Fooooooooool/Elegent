   ...
   private String[] fuanintroduces1 = {"        福建福安白云山，国家风景名胜区、国家4A级旅游景区、世界地质公园、国家地质公园。位于福建省福安市西北部穆云乡、晓阳镇境内，距福安市区约40公里。",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fanhui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(JieshaoActivity.this,DetailsActivity.class);
    ...
    class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
           MyViewHolder holder = new MyViewHolder(LayoutInflater.from(JieshaoActivity.this).inflate(R.layout.jianshao_recycle,parent,false));
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            Glide.with(JieshaoActivity.this).load(images1[position]).into(holder.iv);
